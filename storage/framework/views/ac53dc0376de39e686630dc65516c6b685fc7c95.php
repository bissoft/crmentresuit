                                ...
                                <tr class="cust_tr" id="vend_detail">
                                    <td class="Id">
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('show vender')): ?>
                                            <a href="<?php echo e(route('vender.show',$Vender['id'])); ?>"> <?php echo e(AUth::user()->venderNumberFormat($Vender['vender_id'])); ?>
                                    ...
                                    <td class="Action">
                                        ...
                                        <?php if($Vender['is_active']==0): ?>
                                            ...
                                            <?php else: ?>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('show vender')): ?>
                                                    <a href="<?php echo e(route('vender.show',$Vender['id'])); ?>" class="edit-icon bg-info" data-toggle="tooltip" data-original-title="<?php echo e(__('View')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ItSolzTechOkara\crmentresuit\resources\views/vender/index.blade.php ENDPATH**/ ?>