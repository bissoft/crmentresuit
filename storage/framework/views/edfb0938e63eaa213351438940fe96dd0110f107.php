...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group col-md-6">
            ...
            <?php echo e(Form::text('company_name', '', array('class' => 'form-control','required'=>'required'))); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group col-md-6">
            ...
            <?php echo e(Form::text('position', '', array('class' => 'form-control','required'=>'required'))); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group col-md-6">
            ...
            <?php echo e(Form::text('estimate_budget', '', array('class' => 'form-control','required'=>'required'))); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group col-md-6">
            ...
            <?php echo e(Form::text('phone', '', array('class' => 'form-control','required'=>'required'))); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group col-md-6">
            ...
            <?php echo e(Form::text('website', '', array('class' => 'form-control','required'=>'required'))); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group col-md-6">
            ...
            <?php echo e(Form::text('country', '', array('class' => 'form-control','required'=>'required'))); ?>
...
<?php /**PATH C:\xampp\htdocs\ItSolzTechOkara\crmentresuit\resources\views/leads/create.blade.php ENDPATH**/ ?>