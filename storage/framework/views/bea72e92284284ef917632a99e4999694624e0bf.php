            ...
            <div class="form-group">
                <?php if(!empty($permissions)): ?>
                    ...
                    <table class="table table-striped mb-0" id="dataTable-1">
                        ...
                        <tbody>
                        <?php
                            $modules=['dashboard','user','role','proposal','invoice','bill','revenue','payment','proposal product','invoice product','bill product','goal','bank account','transfer','transaction','product & service','customer','vender','constant tax','constant category','constant unit','constant custom field','company settings','assets','chart of account','journal entry','report'];
...
<?php /**PATH C:\xampp\htdocs\ItSolzTechOkara\crmentresuit\resources\views/role/edit.blade.php ENDPATH**/ ?>