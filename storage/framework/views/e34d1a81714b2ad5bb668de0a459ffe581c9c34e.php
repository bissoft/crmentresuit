...
<?php endif; ?>
    <div class="card">
			...
			<div class="d-flex justify-content-between align-items-center">
				...
				<div class="text-right">
					<div class="actions">
						...
						<a href="/company/credential" class="btn btn-primary pull-right">
							<?php if(!empty($zoom)): ?>
								Update Credentails
							<?php else: ?>
								Add Credentials
        ...
        <?php endif; ?>
		<?php if(!empty($zoom)): ?>
		  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('video_interview_create')): ?>
				<div style="margin-bottom: 10px;" class="row">
						<div class="col-lg-12">
							<a class="btn btn-success" href="<?php echo e(url('/company/create')); ?>">
								Add New
							</a>
						</div>
				</div>
                        ...
                        <?php $__currentLoopData = $interview; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=> $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td style="min-width:180px">
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('video_interview_edit')): ?>
                                        <a class="btn btn-xs btn-info" href="<?php echo e(url('/company/edit/'.$item->id )); ?>">
                                            Edit
                                        </a>
                                    <?php endif; ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('video_interview_delete')): ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\crmentresuit\resources\views/client/company-interview.blade.php ENDPATH**/ ?>