                        ...
                        <table class="table table-striped mb-0 dataTable">
                            ...
                            <?php $__currentLoopData = $bills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="Id">
                                        <?php if(\Auth::guard('vender')->check()): ?>
                                            <a href="<?php echo e(route('vender.bill.show',$bill->id)); ?>"><?php echo e(AUth::user()->billNumberFormat($bill->bill_id)); ?></a>
                                        <?php else: ?>
                                            <a href="<?php echo e(route('bill.show',$bill->id)); ?>"><?php echo e(AUth::user()->billNumberFormat($bill->bill_id)); ?></a>
                                        <?php endif; ?>
                                    </td>
                                    <?php if(!\Auth::guard('vender')->check()): ?>
                                        ...
                                        <td class="Action">
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('duplicate bill')): ?>
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('show bill')): ?>
                                                    <?php if(\Auth::guard('vender')->check()): ?>
                                                        <a href="<?php echo e(route('vender.bill.show',$bill->id)); ?>" class="edit-icon bg-warning" data-toggle="tooltip" data-original-title="<?php echo e(__('Detail')); ?>">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                                                    <?php else: ?>
                                                        <a href="<?php echo e(route('bill.show',$bill->id)); ?>" class="edit-icon bg-warning" data-toggle="tooltip" data-original-title="<?php echo e(__('Detail')); ?>">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                                                    <?php endif; ?>
                                                <?php endif; ?>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit bill')): ?>
                                                    <a href="<?php echo e(route('bill.edit',$bill->id)); ?>" class="edit-icon" data-toggle="tooltip" data-original-title="<?php echo e(__('Edit')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ItSolzTechOkara\crmentresuit\resources\views/bill/index.blade.php ENDPATH**/ ?>