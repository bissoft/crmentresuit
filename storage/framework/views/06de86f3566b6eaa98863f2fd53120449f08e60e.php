                ...
                <div class="col-lg-12 our-system">
                    <div class="row">
                        <ul class="nav nav-tabs my-4">
                            ...
                            <li class="annual-billing">
                                <a data-toggle="tab" href="#email-setting" class=""><?php echo e(__('Email Setting')); ?> </a>
                            </li>
                            <li class="annual-billing">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-sm-6 col-md-6">
                                ...
                                <div class="card setting-card setting-logo-box">
                                    ...
                                    <p class="mt-3 text-primary"> <?php echo e(__('These logo will appear on landing page.')); ?></p>
                                </div>
                            </div>
                            <div class="col-lg-3 col-sm-6 col-md-6">
                            ...
                            <div class="col-lg-3 col-sm-6 col-md-6">
                                <h4 class="small-title"><?php echo e(__('Common Settings')); ?></h4>
                                <div class="card setting-card setting-logo-box">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ItSolzTechOkara\crmentresuit\resources\views/settings/company.blade.php ENDPATH**/ ?>