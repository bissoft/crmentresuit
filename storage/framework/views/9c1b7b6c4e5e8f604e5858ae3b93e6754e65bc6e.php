...
<?php $__env->startSection('content'); ?>
                            ...
                            <div class="timeline timeline-one-side" data-timeline-content="axis" data-timeline-axis-style="dashed">
                                <div class="timeline-block">
                                    ...
                                    <div class="timeline-content">
                                        <div class="text-sm h6"><?php echo e(__('Create Bill')); ?></div>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit bill')): ?>
                                            <div class="Action">
                                                <a href="<?php echo e(route('bill.edit',$bill->id)); ?>" class="edit-icon float-right" data-toggle="tooltip" data-original-title="<?php echo e(__('Edit')); ?>"><i class="fas fa-pencil-alt"></i></a>
                                            </div>
                                        <?php endif; ?>
                                        <small><i class="fas fa-clock mr-1"></i><?php echo e(__('Created on ')); ?> <?php echo e(\Auth::user()->dateFormat($bill->bill_date)); ?></small>
                                    </div>
                                </div>
                                <div class="timeline-block">
                                    <span class="timeline-step timeline-step-sm bg-warning border-warning text-white"><i class="fas fa-envelope"></i></span>
                                    <div class="timeline-content">
                                        <div class="text-sm h6 "><?php echo e(__('Send Bill')); ?></div>
                                        <?php if($bill->status==0): ?>
                                            <div class="Action">
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('send bill')): ?>
                                                    <a href="<?php echo e(route('bill.sent',$bill->id)); ?>" class="send-icon float-right" data-toggle="tooltip" data-original-title="<?php echo e(__('Mark Sent')); ?>"><i class="fa fa-paper-plane"></i></a>
                                                <?php endif; ?>
                                            </div>
                                        <?php endif; ?>
                                        <?php if($bill->status!=0): ?>
                                            <small><i class="fas fa-clock mr-1"></i><?php echo e(__('Sent on')); ?> <?php echo e(\Auth::user()->dateFormat($bill->send_date)); ?></small>
                                        <?php else: ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('send bill')): ?>
                                ...
                                <div class="timeline-block">
                                    ...
                                    <div class="timeline-content">
                                        <span class="text-sm h6 "><?php echo e(__('Get Paid')); ?></span>
                                        <?php if($bill->status!=0): ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create payment bill')): ?>
                                                <a href="#" data-url="<?php echo e(route('bill.payment',$bill->id)); ?>" data-ajax-popup="true" data-title="<?php echo e(__('Add Payment')); ?>" class="edit-icon float-right" data-toggle="tooltip" data-original-title="<?php echo e(__('Add Payment')); ?>"><i class="fas fa-money-bill-alt"></i></a> <br>
                                            <?php endif; ?>
                                        <?php endif; ?>
                                        <small><?php echo e(__('Status')); ?> : <?php echo e(__('Awaiting payment')); ?></small>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-12 d-flex align-items-center justify-content-between justify-content-md-end">
                    <?php if(!empty($billPayment)): ?>
                        <div class="all-button-box mx-2">
                            <a href="#" data-url="<?php echo e(route('bill.debit.note',$bill->id)); ?>" data-ajax-popup="true" data-title="<?php echo e(__('Add Debit Note')); ?>" class="btn btn-xs btn-white btn-icon-only width-auto">
                    ...
                    <?php endif; ?>
                    <div class="all-button-box mx-2">
                        <a href="<?php echo e(route('bill.resent',$bill->id)); ?>" class="btn btn-xs btn-white btn-icon-only width-auto">
                            <?php echo e(__('Resend Bill')); ?>

                        </a>
                    </div>
                    <div class="all-button-box">
                        <a href="<?php echo e(route('bill.pdf', Crypt::encrypt($bill->id))); ?>" target="_blank" class="btn btn-xs btn-white btn-icon-only width-auto">
    ...
    <?php else: ?>
        <div class="row justify-content-between align-items-center mb-3">
            <div class="col-md-12 d-flex align-items-center justify-content-between justify-content-md-end">
                <div class="all-button-box mx-2">
                    <a href="#" data-url="<?php echo e(route('vender.bill.send',$bill->id)); ?>" data-ajax-popup="true" data-title="<?php echo e(__('Send Bill')); ?>" class="btn btn-xs btn-white btn-icon-only width-auto">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped">
                                            <tr>
                                                ...
                                                <th class="text-dark">  <?php if($bill->discount_apply==1): ?>
                                            ...
                                            <?php $__currentLoopData = $iteams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key =>$iteam): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>  <?php if($bill->discount_apply==1): ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right"><?php echo e(\Auth::user()->priceFormat($bill->getSubTotal())); ?></td>
                                            </tr>
                                            <?php if($bill->discount_apply==1): ?>
                                                <tr>
                                                    <td colspan="5"></td>
                                                    <td class="text-right"><b><?php echo e(__('Discount')); ?></b></td>
                                                    <td class="text-right"><?php echo e(\Auth::user()->priceFormat($bill->getTotalDiscount())); ?></td>
                                                </tr>
                                            <?php endif; ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="blue-text text-right"><?php echo e(\Auth::user()->priceFormat($bill->getTotal())); ?></td>
                                            </tr>
                                            <tr>
                                                <td colspan="5"></td>
                                                <td class="text-right"><b><?php echo e(__('Paid')); ?></b></td>
                                                <td class="text-right"><?php echo e(\Auth::user()->priceFormat(($bill->getTotal()-$bill->getDue())-($bill->billTotalDebitNote()))); ?></td>
                                            </tr>
                                            <tr>
                                                <td colspan="5"></td>
                                                <td class="text-right"><b><?php echo e(__('Debit Note')); ?></b></td>
                                                <td class="text-right"><?php echo e(\Auth::user()->priceFormat(($bill->billTotalDebitNote()))); ?></td>
                                            </tr>
                                            <tr>
                                                <td colspan="5"></td>
                                                <td class="text-right"><b><?php echo e(__('Due')); ?></b></td>
                                                <td class="text-right"><?php echo e(\Auth::user()->priceFormat($bill->getDue())); ?></td>
                                            </tr>
                                            </tfoot>
                                        </table>
                                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit debit note')): ?>
                                            <a data-url="<?php echo e(route('bill.edit.debit.note',[$debitNote->bill,$debitNote->id])); ?>" data-ajax-popup="true" data-title="<?php echo e(__('Add Debit Note')); ?>" href="#" class="edit-icon" data-toggle="tooltip" data-original-title="<?php echo e(__('Edit')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ItSolzTechOkara\crmentresuit\resources\views/bill/view.blade.php ENDPATH**/ ?>