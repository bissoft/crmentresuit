<div class="card bg-none card-box">
    ...
    <div class="row">
        ...
        <!-- <div class="form-group col-md-6">
            ...
            <?php echo e(Form::select('tax_id[]', $tax,null, array('class' => 'form-control select2','multiple','required'=>'required'))); ?>
...
<?php /**PATH C:\xampp\htdocs\ItSolzTechOkara\crmentresuit\resources\views/productservice/create.blade.php ENDPATH**/ ?>