                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <select name="department_id"
                            ...
                            <option value="2" <?php if($ticket->department_id == 2): ?> selected <?php endif; ?>>Account Receivable and Payable</option>
                            <option value="3" <?php if($ticket->department_id == 3): ?> selected <?php endif; ?>>Care Team</option>
                            <option value="1" <?php if($ticket->department_id == 1): ?> selected <?php endif; ?>>Marketing</option>
                        </select>
                        <div class="invalid-feedback d-block"></div>
                    </div>
                    <div class="form-group col-md-6">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select name="ticket_status_id"
                            class='form-control selectPickerWithoutSearch'>
                            <option value="1" <?php if($ticket->ticket_status_id == 1): ?> selected <?php endif; ?>>Open</option>
                            <option value="2" <?php if($ticket->ticket_status_id == 2): ?> selected <?php endif; ?>>In Progress</option>
                            <option value="3" <?php if($ticket->ticket_status_id == 3): ?> selected <?php endif; ?>>Answered</option>
                            <option value="4" <?php if($ticket->ticket_status_id == 4): ?> selected <?php endif; ?>>On Hold</option>
                            <option value="5" <?php if($ticket->ticket_status_id == 5): ?> selected <?php endif; ?>>Closed</option>
                        </select>
                        <div class="invalid-feedback d-block"></div>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <select name="ticket_priority_id"
                            class='form-control selectPickerWithoutSearch'>
                            <option value="" selected="selected">Select</option>
                            <option value="1" <?php if($ticket->ticket_priority_id == 1): ?> selected <?php endif; ?> >High</option>
                            <option value="3" <?php if($ticket->ticket_priority_id == 3): ?> selected <?php endif; ?> >Low</option>
                            <option value="2" <?php if($ticket->ticket_priority_id == 2): ?> selected <?php endif; ?> >Medium</option>
                        </select>
                        <div class="invalid-feedback d-block"></div>
                    </div>
                    <div class="form-group col-md-6">
                        ...
                        <select name="ticket_service_id"
                            class='form-control selectPickerWithoutSearch'>
                            <option value="" selected="selected">Select</option>
                            <option value="3" <?php if($ticket->ticket_service_id == 3): ?> selected <?php endif; ?> >b</option>
                            <option value="1" <?php if($ticket->ticket_service_id == 1): ?> selected <?php endif; ?> >Companion Care</option>
                            <option value="2" <?php if($ticket->ticket_service_id == 2): ?> selected <?php endif; ?> >Personal Care</option>
                        </select>
                        <div class="invalid-feedback d-block"></div>
                    </div>
                </div>
...
</div><?php /**PATH C:\xampp\htdocs\ItSolzTechOkara\crmentresuit\resources\views/tickets/edit.blade.php ENDPATH**/ ?>