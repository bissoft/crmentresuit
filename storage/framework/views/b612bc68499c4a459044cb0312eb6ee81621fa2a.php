<div class="card bg-none card-box">
    <form action="<?php echo e(route('predefined-replies.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <div class="row">
            <div class="col-md-12">
...
<?php /**PATH C:\xampp\htdocs\ItSolzTechOkara\crmentresuit\resources\views/predefined-replies/create.blade.php ENDPATH**/ ?>