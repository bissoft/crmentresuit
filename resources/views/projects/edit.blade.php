            ...
            <div class="main-content">
                ...
                <div class="form-group mb-3 ">
                    ...
                    <input name="progress" id="progress" style="border: none !important;" type="range" min="0" max="100"
                        step="1" value="{{$project->progress}}" class="form-control ">
                    <div class="invalid-feedback d-block"></div>
                </div>
                <div class="row mt-4">
                    <div class="col">
                        <div class="form-group mb-3">
                            ...
                            <select name="billing_type_id" class='form-control  selectPickerWithoutSearch'>
                                ...
                                <option value="1" @if($project->billing_type_id == 1) selected @endif>Fixed Rate</option>
                                <option value="2" @if($project->billing_type_id == 2) selected @endif>Project Hours</option>
                                <option value="3" @if($project->billing_type_id == 3) selected @endif>Task Hours</option>
                            </select>
                            <div class="invalid-feedback d-block"></div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-group mb-3">
                            ...
                            <select name="status_id" class='form-control  selectPickerWithoutSearch'>
                                <option value="1" @if($project->status_id == 1) selected @endif>Not Started</option>
                                <option value="2" @if($project->status_id == 2) selected @endif>In Progress</option>
                                <option value="3" @if($project->status_id == 3) selected @endif>On Hold</option>
                                <option value="4" @if($project->status_id == 4) selected @endif>Cancelled</option>
                                <option value="5" @if($project->status_id == 5) selected @endif>Finished</option>
                            </select>
                            <div class="invalid-feedback d-block"></div>
                        </div>
                    </div>
                ...
                <div class="form-group mb-3 billing_rate" style="">
                    ...
                    <input type="text" class="form-control  " id="billing_rate" name="billing_rate" value="{{ $project->billing_rate }}">
                    <div class="invalid-feedback d-block"></div>
                </div>
                <div class="row">
                    <div class="col">
                    ...
                    <div class="col">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control datepicker" id="dead_line"
                                name="dead_line" value="{{ $project->dead_line }}">
                            <div class="invalid-feedback d-block"></div>
                        </div>
                    </div>
                </div>
