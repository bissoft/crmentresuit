                                ...
                                <tr class="font-style">
                                    ...
                                    <td class="Action">
                                        ...
                                        @can('edit constant tax')
                                                <a href="#" class="edit-icon" data-url="{{ route('lead-sources.edit',$source->id) }}" data-ajax-popup="true" data-title="{{__('Edit Lead Source')}}" data-toggle="tooltip" data-original-title="{{__('Edit')}}">
