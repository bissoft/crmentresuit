                        ...
                        <table class="table table-striped mb-0 dataTable">
                            ...
                            @foreach ($venders as $k=>$Vender)
                                <tr class="cust_tr" id="vend_detail">
                                    <td class="Id">
                                        @can('show vender')
                                            <a href="{{ route('vender.show',$Vender['id']) }}"> {{ AUth::user()->venderNumberFormat($Vender['vender_id']) }}
                                            </a>
                                        @else
                                    ...
                                    <td class="Action">
                                        ...
                                        @if($Vender['is_active']==0)
                                            ...
                                            @else
                                                @can('show vender')
                                                    <a href="{{ route('vender.show',$Vender['id']) }}" class="edit-icon bg-info" data-toggle="tooltip" data-original-title="{{__('View')}}">
