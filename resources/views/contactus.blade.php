          ...
          <div class="card shadow-lg">
            <div class="row gx-0">
              <div class="col-lg-6 image-wrapper bg-image bg-cover rounded-top rounded-lg-start d-none d-md-block"
                data-image-src="{{asset('../assets/img/li-2.jpg')}}"></div>
              <!--/column -->
              <div class="col-lg-6">
            ...
            <div class="col-lg-8">
              <form class="contact-form needs-validation" method="post"
                ...
                <div class="row gx-4">
                  ...
                  <div class="col-md-6">
                    <div class="form-floating mb-4">
                      <input id="form_lastname" type="text" name="surname" class="form-control" placeholder="Doe"
                        required />
                  ...
                  <p class="mb-0">
                    <a href="#"
                      class="link-body"><span class="__cf_email__"
                        data-cfemail="3546545b51575a4d755058545c591b565a58">Quotes@entresuitecrm.com</span></a>
                  </p>
