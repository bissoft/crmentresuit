        ...
        <div class="card ">
            <div class="Signer-card">
                <div class="card-header bg-header text-white">
                    <h5>Send Email or Take Signature</h5>
                                ...
                                <div class="d-flex justify-content-between align-items-center bg-light px-2 py-1">
                                    ...
                                    <div class="d-flex my-1">
                                        <button class="btn  bg-transparent px-2 "
                                                ...
                                                data-toggle="modal" data-target="#editDocumentUserModal" title="Edit">
                                            <i class=" icon-edit text-primary fa-lg"></i>
                                        </button>
                                        <a href="/signature/{{ $user->id }}/{{ $user->email }}" class="btn px-2 bg-transparent" title="Take Signature">
                                            <i class="icon-pen text-primary fa-lg"></i>
                                        </a>
                                        <button class="btn bg-transparent px-2"
                                                onclick="deleteDocumentUser('{{$user->id}}')" title="Remove">
    ...
    <div id="myModal" class="modal fade" role="dialog">
        <div class="modal-1 modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>By Clicking this “Add Signers” Button you can add users to this Documents, who you can send this
                        document to for signature.</p>
                </div>
                <div class="modal-footer">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false"><i class="fas fa-drafting-compass mr-2"></i>Draw</a>
                            </li>
                            <li class="nav-item">
