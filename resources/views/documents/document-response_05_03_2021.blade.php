        ...
        <div class="row mt-5">
            <div class="col-md-12">
                <form id="regForm" action="#" method="post">
                    @csrf
                    <h3>A new document from {{ config('app.name') }}, LLC is available for yor to sign.</h3>
                    <!-- One "tab" for each step in the form: -->
                    @if($signature || $text)
                        <div class="tabs">Signature Blow:
                            <div class="row mb-3">
                                @if($signature)
                    ...
                    <div class="tabs"><span id="documentComplete"></span>:
                        <p>
                            <a type="button" href="{{route('download.document.file',[$id,$user_id,$send_id])}}"
                               class="custom_button" id="downloadButton" style="color: white;text-decoration: none;">
                                <i class="fa fa-print"></i> Download
                            </a>
                        </p>
                    </div>
                    <div id="finish" style="display: none;">
                        <div style="background: #79e49c;padding: 10px 30px;">
                    ...
                    <div style="overflow:auto;">
                        <div style="float:right;">
                            <button type="button" class="custom_button" id="prevBtn" onclick="nextPrev(-1)">Previous
                            </button>
                            <button type="button" class="custom_button" id="nextBtn" onclick="nextPrev(1)">Next</button>
                        </div>
                    </div>
