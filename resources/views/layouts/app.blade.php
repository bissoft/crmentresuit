                ...
                <div class="container">
                    <div class="primary-menu">
                        <div class="site-branding">
                            <a href="{{url('/')}}" class="brand-logo"><img src="{{ asset('assets/img/logo_white.png') }}" alt="Site Logo"></a>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="widget contact-info-widget mb-40" data-aos="fade-up" data-aos-delay="60">
                                ...
                                <ul class="info-list">
                                    <li><span><i class="far fa-phone"></i><a href="tel:+123-589-847">770-882-4207</a></span></li>
