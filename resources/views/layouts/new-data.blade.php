...
<section class="wrapper bg-light">
    <div class="container py-14 py-md-16 pb-md-17">
            ...
            <div class="col-lg-5">
                ...
                <div class="d-flex flex-row mb-6">
                    ...
                    <div>
                        ...
                        <p class="mb-0">Your Client can book their appointments with you or any member of your team seamlessly</p>
                    </div>
                </div>
				...
				<div class="d-flex flex-row">
                    ...
                    <div>
                        ...
                        <p class="mb-0">  Customize your subscription with your company’s brand and logo to improve customer experience</p>
                    </div>
                </div>
        ...
        <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
            ...
            <!--/column -->
            <div class="col-lg-5">
                <h3 class="display-4 mb-7 mt-lg-10">Discover why entrepreneurs all over the world, choose EntreSuite to run their business.
                ...
                <div class="accordion accordion-wrapper" id="accordionExample">
                    <div class="card plain accordion-item">
                        ...
                        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                            ...
                            <div class="card-body">
                                <p>Businesses of all types rely on us to make their day to day operations function seamlessly. EntreSuite CRM allows businesses to run more efficiently by using automated features, we are able to save over several hours per week by completely streamlining and managing workflow
                    ...
                    <div class="card plain accordion-item">
                        ...
                        <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                            data-bs-parent="#accordionExample">
                            <div class="card-body">
                                <p>Coaches, accounting & financial services firms, law firms, beauty, industry professionals, event planners and 100s of others — run on EntreSuite CRM.</p></div>
                            <!--/.card-body -->
                        </div>
                        <!--/.accordion-collapse -->
                    </div>
                    ...
                    <div class="card plain accordion-item">
                        ...
                        <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                            data-bs-parent="#accordionExample">
                            <div class="card-body">
                                <p>We provide clients with a custom branded portal which can be managed on web and mobile device. </p></div>
                            <!--/.card-body -->
                        </div>
                        <!--/.accordion-collapse -->
                    </div>
        ...
        <div class="row gx-lg-8 gx-xl-12 gy-10 mb-8 align-items-center">
            ...
            <div class="col-lg-5">
               <!-- <h2 class="fs-16 text-uppercase text-muted mb-3">Analyze Now</h2> -->
                ...
                <p class="mb-7">The average Entrepreneur/ small business uses 5 to 6 applications to run their business. This means that they are paying several monthly subscriptions and are more likely to spend more time toggling between these applications. 
EntreSuite will give them the tools they need to execute these tasks more efficiently. The key features of the software includes: calendars/ scheduling, payments/ invoicing, tasks assignments and tracking, marketing campaigns, contracts, forms, eSignature capabilities, expense tracking and more. We will package these features in the most cost-effective way so that our clients can save on monthly subscriptions and potentially increase productivity</p>
                <div class="row">
                    <div class="col-lg-9">
                        <form action="#">
                            <div class="form-floating input-group">
                                <input type="url" class="form-control" placeholder="Enter Website URL" id="seo-check">
                                <label for="seo-check">Enter your email</label>
        ...
        <div class="position-relative mt-8 mt-lg-n23 mt-xl-n25">
            <div class="row text-center">
                <div class="col-lg-8 col-xl-7 col-xxl-6 mx-auto">
                    ...
                    <h3 class="display-4 mb-10 px-md-13 px-lg-4 px-xl-0"></h3>
                </div>
                <!-- /column -->
            </div>
            <!-- /.row -->
                ...
                <div class="row grid-view gy-6 gy-xl-0">
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="card shadow-lg">
                            <div class="card-body">
                                <img class="rounded-circle w-15 mb-4" src="{{ url('public/app/assets/img/avatars/te2.jpg') }}"
                                    srcset="{{ url('public/app/assets/img/avatars/te2@2x.jpg 2x') }}" alt="" />
                                <h4 class="mb-1">Dr. Shy</h4>
                                <div class="meta mb-2">Dr. Shy Courtney is the CEO/ Founder of EntreSuite CRM and The Winners Group LLC. A financial services firm located in Suwanee GA. </div>
                                <p class="mb-2">Dr. Shy's diverse work experience also includes, Start up Coach/ Consultant to international businesses, Sales Trainer to SAAS companies, Customer Success Business Development Development Manager.</p>
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="card shadow-lg">
                            <div class="card-body">
                                <img class="rounded-circle w-15 mb-4" src="{{ url('public/app/assets/img/avatars/te3.jpg') }}"
                                    srcset="{{ url('public/app/assets/img/avatars/te3@2x.jpg 2x') }}" alt="" />
                                <h4 class="mb-1">Raymond Saylor </h4>
                                <div class="meta mb-2">Raymond Saylor is the company's CPA who has been practicing in his field for over 30 years. He has been with the firm since formation and handles the company's Financials. </div>
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="card shadow-lg">
                            <div class="card-body">
                                <img class="rounded-circle w-15 mb-4" src="{{ url('public/app/assets/img/avatars/te4.jpg') }}"
                                    srcset="{{ url('public/app/assets/img/avatars/te4@2x.jpg 2x') }}" alt="" />
                                <h4 class="mb-1">Sarah Boorsma</h4>
                                <div class="meta mb-2">Sarah Boorsma is our Operations Manager who has also been working with The Winners Group LLC. since formation. She oversees the day to day operations of the Company and will be a key part of building and training our Teams.</div>
