                                ...
                                <tr class="font-style">
                                    ...
                                    @if(Gate::check('edit proposal') || Gate::check('delete proposal') || Gate::check('show proposal'))
                                        <td class="Action">
                                            ...
                                            @else
                                                @can('convert invoice')
                                                    <a href="{{ route('invoice.show',$proposal->converted_invoice_id) }}" class="edit-icon bg-warning" data-toggle="tooltip" data-original-title="{{__('Already convert to Invoice')}}" data-toggle="tooltip" data-original-title="{{__('Delete')}}">
