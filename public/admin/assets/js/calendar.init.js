! function(l) {
    "use strict";
    var e = function() {
        this.$body = l("body"), this.$modal = l("#event-modal"), this.$event = "#external-events div.external-event", this.$calendar = l("#calendar"), this.$saveCategoryBtn = l(".save-category"), this.$categoryForm = l("#add-category form"), this.$extEvents = l("#external-events"), this.$calendarObj = null
    };
